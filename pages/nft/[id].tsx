  ...
  return (
    <div className=' flex h-screen flex-col 
          ...
          <div className=' flex flex-col 
            ...
            py-2 lg:min-h-screen '>
             ...
             <div className=' p-5 text-center space-y-2 '>
                 ...
                 text-white '>ATULJAISS Apes</h1>
                 <h2 className='text-xl text-gray-300'>A collection of Atul jaiss Apes who live & breathe react</h2>
             </div>
        ...
        <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
            ...
            {address && (
                <p className='text-center text-sm text-rose-400'>You're login in with wallet {address.substring(0,5)}...{address.substring(address.length-5)}</p>
            )}
            {/* content */}
            ...
            space-y-6 text-center lg:space-y-0 lg:justify-center'>
                ...
                lg:text-5xl'>The ATULJAISS Ape Coding Club | NFT Drop</h1>
